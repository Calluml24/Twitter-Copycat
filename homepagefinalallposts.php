...
?>
<!--- PAGE IS CALLED TO SHOW ALL POSTS EVER MADE --->
					...
					INNER JOIN tags ON tags.tagid = posttaglink.tagid)";
						...
						while($row3 = mysqli_fetch_assoc($result3)){
							...
							if(!empty($commentUserProfile)){
								...
								<a href='profileOtherUserFinal.php?user=$commentUserid'>".$commentUsername."</a> ".$comment."<small class='text-muted'> ".$commentDate."</small><br></li>";
							} else {
								echo"<ul class='list-group list-group-flush'>";
