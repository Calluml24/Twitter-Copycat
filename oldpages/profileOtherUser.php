...
<div class="container">
	<div class="container text-left">
		...
		while($row = mysqli_fetch_assoc($result)) {
			...
			//PROFILE TEXT PRINT 
			echo"First Name: <br>".$firstName."<br><br>";
			echo"Last Name: <br>".$lastName."<br><br>";
			echo"Age: <br>".$age."<br><br>";
			echo"Gender: <br>".$gender."<br><br>";
			echo"Biography: <br>".$biography."<br><br>";
		}
		?>
	...
	$query = "SELECT accounts.userid, accounts.username,accounts.profilepath, posts.postid, posts.post, posts.postTimeCreated 
			...
			WHERE accounts.userid = $postUserid
